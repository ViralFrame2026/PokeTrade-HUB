...
export const metadata = {
  title: "Términos",
  description: "Condiciones básicas de uso para NexoTCG."
};
...
const terms = [
  ...
  },
  {
    ...
    copy: "La plataforma facilita contacto, reputación, moderación y organización, pero cada comprador y vendedor debe verificar autenticidad, estado, pago, envío y entrega."
  },
  {
    icon: BadgeDollarSign,
    title: "Pagos y monetización futura",
    copy: "Por ahora los pagos se acuerdan entre usuarios fuera de la plataforma. La integración de pagos, comisiones automáticas o planes quedará para una etapa posterior."
  },
  {
    icon: ShieldAlert,
  ...
  },
  {
    ...
    copy: "No se permite publicar falsificaciones, productos re-sellados como nuevos, fotos robadas, spam, amenazas, fraude, presión indebida o acuerdos pensados para evadir seguridad."
  },
  {
    icon: UserCog,
...
const importantNotes = [
  ...
  "Las operaciones de pago, envío o entrega acordadas entre usuarios quedan bajo responsabilidad de quienes participan.",
  "Los reportes falsos, abusivos o hechos para perjudicar a otro usuario también pueden ser moderados.",
  "Dominio propio, correo profesional y pagos integrados quedan reservados para la etapa final de lanzamiento."
];
      ...
      <section className="mx-auto max-w-4xl space-y-5 px-4 py-12 sm:px-6 lg:px-8">
        ...
        <article className="rounded-lg border border-white/10 bg-white/[0.06] p-6">
          ...
          <p className="mt-3 leading-7 text-blue-100">
            ...
            monetización, integra pagos, mejora seguridad o incorpora nuevas herramientas para
        ...
        <article className="rounded-lg border border-yellow-300/30 bg-yellow-400/10 p-6">
          ...
          <p className="mt-3 leading-7 text-blue-100">
            Para consultas generales o situaciones no previstas, escribí a {SUPPORT_EMAIL}.
          </p>
          <div className="mt-5">
