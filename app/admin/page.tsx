        ...
        <section className="glass mt-8 rounded-lg p-5">
          <div className="flex flex-col justify-between gap-3 border-b border-white/10 pb-5 sm:flex-row sm:items-end">
            <div>
              ...
              <h2 className="mt-2 text-xl font-black text-white">Pagos y comisiones</h2>
          ...
          <div className="mt-5 border-t border-white/10 pt-5">
            <div className="flex flex-col justify-between gap-3 sm:flex-row sm:items-end">
              <div>
                ...
                <p className="mt-2 text-sm text-slate-400">
                  Control interno de comisiones generadas por ventas que los vendedores cobran directo.
                </p>
              </div>
